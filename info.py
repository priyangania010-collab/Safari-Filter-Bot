...
API_ID = int(environ.get('API_ID', "254965"))
API_HASH = environ.get('API_HASH', "d1af2ebbfb1fe438cae67372abf1")
BOT_TOKEN = environ.get('BOT_TOKEN', "83460828:AAHSUA-9b6AV9f1QqdF6JYImVAavCOU")
...
QR_CODE = environ.get('QR_CODE', 'https://amanshah.serv00.net/images/BqRZWWv/file-150.jpg') # Scanner Code image 
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002456874247'))
...
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002324418733)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002324418733)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002408329772")) 
